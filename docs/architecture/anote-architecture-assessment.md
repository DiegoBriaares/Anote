...
- **APP-GATE:** ESLint, the production TypeScript/Vite build and 34/34 test
  files with 135/135 tests passed on the review-corrected source.
  `server/backendHardening.test.ts` passed 28/28, including migration,
...
- **CC-GATE:** the Control Center owner suite passed 68/68 tests. The CLI
