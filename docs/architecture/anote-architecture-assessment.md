...
- **APP-GATE:** ESLint, the production TypeScript/Vite build and 31/31 test
  files with 131/131 tests passed on the review-corrected source.
...
- **CC-GATE:** the Control Center owner suite passed 65/65 tests. The CLI
