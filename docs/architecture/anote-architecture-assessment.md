...
- **APP-GATE:** ESLint, the production TypeScript/Vite build and 31/31 test
  files with 130/130 tests passed on the review-corrected source.
  `server/backendHardening.test.ts` passed 24/24, including migration,
...
- **CC-GATE:** the Control Center owner suite passed 64/64 tests. The CLI
