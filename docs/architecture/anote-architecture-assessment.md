...
- **APP-GATE:** ESLint, the production TypeScript/Vite build and 34/34 test
  files with 136/136 tests passed on the review-corrected source.
  `server/backendHardening.test.ts` passed 29/29, including migration,
...
- **CC-GATE:** the Control Center owner suite passed 69/69 tests. The CLI
