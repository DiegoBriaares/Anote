...
const english = {
    ...
    profile: {
        ...
        passwordDescription: 'Confirm your current password, then choose a new one. Other signed-in sessions will end.',
        currentPassword: 'Current password',
        newPassword: 'New password',
        confirmPassword: 'Confirm new password',
        passwordHelp: 'Use at least 8 characters. Long passwords are welcome up to the secure 72-byte limit.',
    ...
    programs: {
        eyebrow: 'AUTOMATIC PROGRAMS', title: 'Programs', description: 'Anote runs enabled programs even when this browser is closed.', add: 'Add program', manualEyebrow: 'MANUAL RUN', manualTitle: 'Run a program now', program: 'Program', sourceDate: 'Source date', targetDate: 'Target date', useOffset: 'Use the program offset', run: 'Run program', running: 'Running…', scheduleEyebrow: 'SCHEDULE', definitionsTitle: 'Program definitions', name: 'Name', activationTime: 'Activation time', targetOffset: 'Target offset', timeZone: 'Time zone', timeZonePlaceholder: 'GMT-6 or America/Mexico_City', timeZoneHelp: 'Enter a GMT offset from GMT-12 through GMT+14, including minute offsets, or an IANA time zone.', actions: 'Actions', defaultName: 'Move unfinished events', invalidTime: 'Enter a valid 24-hour time from 00:00 through 23:59.', invalidTimeZone: 'Enter a valid time zone such as GMT-6, GMT+5:30, or America/Mexico_City.', saved: 'Programs saved.', deleted: 'Program deleted.', deleteConfirm: 'Delete this program?', runStarted: 'Running {name}…', runCompleted: '{name} moved {count} unfinished events.', runFailed: '{name} could not run. Try again.', nextRun: 'Next run: {date}', noPrograms: 'Add a program to automate unfinished event moves.', save: 'Save programs', dismissNotice: 'Dismiss program result'
    },
    ...
    errors: {
        REQUEST_FAILED: 'That action could not be completed. Try again.', INVALID_RESPONSE: 'Anote received an unexpected service response. Try again; if it continues, open diagnostics.', SERVICE_UNAVAILABLE: 'Anote is unavailable right now. Check your connection and try again.', ORIGIN_NOT_ALLOWED: 'This address is not forwarding Anote securely. Open Anote from its direct address or review the Tailscale Serve address and try again.', SESSION_REQUIRED: 'Your session ended. Sign in again to continue.', INVALID_CREDENTIALS: 'The username or password is incorrect.', CURRENT_PASSWORD_REQUIRED: 'Enter your current password.', CURRENT_PASSWORD_INCORRECT: 'The current password is incorrect.', PASSWORD_TOO_SHORT: 'Use at least 8 characters for the new password.', PASSWORD_TOO_LONG: 'Use a shorter password that is no more than 72 UTF-8 bytes.', PASSWORD_CHANGED: 'Your password changed in another session. Sign in again and retry.', INVALID_PROGRAM_TIME_ZONE: 'Enter a valid GMT offset or IANA time zone.', REGISTRATION_DISABLED: 'New account creation is currently closed.', IMMUTABLE_CONFIG_KEY: 'Account creation is always available and cannot be turned off.', RATE_LIMITED: 'Too many attempts. Wait a few minutes and try again.', VALIDATION_FAILED: 'Review the information and try again.', REVISION_CONFLICT: 'This item changed elsewhere. Refresh it before saving again.', FORBIDDEN: 'You do not have access to that item.', NOT_FOUND: 'That item is no longer available.', ATTACHMENT_TYPE_NOT_ALLOWED: 'Choose a supported image or document type.', ATTACHMENT_TOO_LARGE: 'Choose a smaller file and try again.'
    },
...
const spanish: AppText = {
    ...
    profile: {
        eyebrow: 'PERFIL', title: 'Apariencia', description: 'Personaliza tu calendario. Estas opciones solo afectan tu vista; los calendarios de amistades siguen siendo de solo lectura.', username: 'Usuario', backgroundImageUrl: 'URL de la imagen de fondo', backgroundHelp: 'Déjalo vacío para usar el degradado predeterminado.', accent: 'Color de acento', accentText: 'Valor del color de acento', noiseOverlay: 'Agregar textura', theme: 'Tema', light: 'Claro', dark: 'Oscuro', themeHelp: 'Elige una interfaz clara o cómoda para la noche. La opción se guarda en tu perfil.', reset: 'Restablecer apariencia', save: 'Guardar preferencias', passwordTitle: 'Cambiar contraseña', passwordDescription: 'Confirma tu contraseña actual y elige una nueva. Las demás sesiones abiertas se cerrarán.', currentPassword: 'Contraseña actual', newPassword: 'Nueva contraseña', confirmPassword: 'Confirmar nueva contraseña', passwordHelp: 'Usa al menos 8 caracteres. Se permiten contraseñas largas hasta el límite seguro de 72 bytes.', passwordsDoNotMatch: 'Las contraseñas nuevas no coinciden.', changePassword: 'Cambiar contraseña', passwordChanged: 'Contraseña actualizada. Inicia sesión con tu nueva contraseña.'
    },
    roles: {
    ...
    programs: {
        eyebrow: 'PROGRAMAS AUTOMÁTICOS', title: 'Programas', description: 'Anote ejecuta los programas activos aunque este navegador esté cerrado.', add: 'Agregar programa', manualEyebrow: 'EJECUCIÓN MANUAL', manualTitle: 'Ejecutar un programa ahora', program: 'Programa', sourceDate: 'Fecha de origen', targetDate: 'Fecha de destino', useOffset: 'Usar el desplazamiento del programa', run: 'Ejecutar programa', running: 'Ejecutando…', scheduleEyebrow: 'HORARIO', definitionsTitle: 'Definiciones de programas', name: 'Nombre', activationTime: 'Hora de activación', targetOffset: 'Días de desplazamiento', timeZone: 'Zona horaria', timeZonePlaceholder: 'GMT-6 o America/Mexico_City', timeZoneHelp: 'Escribe un desplazamiento entre GMT-12 y GMT+14, incluso con minutos, o una zona horaria IANA.', actions: 'Acciones', defaultName: 'Mover eventos sin terminar', invalidTime: 'Escribe una hora válida de 24 horas entre 00:00 y 23:59.', invalidTimeZone: 'Escribe una zona válida como GMT-6, GMT+5:30 o America/Mexico_City.', saved: 'Programas guardados.', deleted: 'Programa eliminado.', deleteConfirm: '¿Eliminar este programa?', runStarted: 'Ejecutando {name}…', runCompleted: '{name} movió {count} eventos sin terminar.', runFailed: 'No se pudo ejecutar {name}. Inténtalo de nuevo.', nextRun: 'Próxima ejecución: {date}', noPrograms: 'Agrega un programa para automatizar el movimiento de eventos sin terminar.', save: 'Guardar programas', dismissNotice: 'Cerrar resultado del programa'
    },
