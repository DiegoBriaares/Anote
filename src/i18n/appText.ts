...
const english = {
    ...
    admin: {
        ...
        rawData: 'Data viewer',
        rawDataDescription: 'Inspect stored role and event-note records.',
        rolesTable: 'Roles',
        notesTable: 'Event notes',
        records: 'records',
