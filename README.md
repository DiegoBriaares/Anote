...
- **Calendar Page**: two-month planning workspace with in-calendar day selection, friend read-only mode, day inspection, day visual settings, selected-day event reading, selected-day event sharing, and explicit group event day marking.
